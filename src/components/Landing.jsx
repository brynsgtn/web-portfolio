...
export default function Landing(){
    return(
        ...
        <section className='hero animate__animated animate__zoomIn'>        
            ...
            <a href="#about" className="has-text-primary has-text-weight-bold"><button className='mt-6 p-4 button is-primary is-outlined learn'><strong>Learn More</strong></button></a>
          </section>
        </>
